...
すべてのテーブルにおいて、`id` は自動採番の主キー（PK）とする。

複合UKは、`UK1`, `UK2` など番号で対応関係を示す。

### 1.1 ユーザーテーブル (users)
| No | PK | UK | カラム名 | 項目名 | 概要 | データ型 | 長さ | NOT NULL | 列制約 | 備考 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | 〇 | | id | ユーザーID | ユーザーを一意に識別するID | SERIAL | - | 〇 | | |
| 2 | | 〇 | username | ユーザー名 | ユーザーの表示名 | VARCHAR | 50 | 〇 | | 単独UK |
| 3 | | 〇 | email | メールアドレス | ログインや通知用のアドレス | VARCHAR | 255 | 〇 | | 単独UK |
...
| No | PK | UK | カラム名 | 項目名 | 概要 | データ型 | 長さ | NOT NULL | 列制約 | 備考 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | 〇 | | id | プロジェクトID | プロジェクトを一意に識別するID | SERIAL | - | 〇 | | |
| 1 | 〇 | 〇 | owner_id | オーナーID | 紐づくユーザーID | SERIAL | - | 〇 | FK (users.id) | |
...
| No | PK | UK | カラム名 | 項目名 | 概要 | データ型 | 長さ | NOT NULL | 列制約 | 備考 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | 〇 | | id | ID | メンバー紐付けを一意に識別するID | SERIAL | - | 〇 | | |
| 2 | | 〇 | project_id | プロジェクトID | 紐づくプロジェクトのID | SERIAL | - | 〇 | FK (projects.id) | UK1 |
| 3 | | 〇 | user_id | ユーザーID | 紐づくユーザーのID | SERIAL | - | 〇 | FK (users.id) | UK1 |
...
| No | PK | UK | カラム名 | 項目名 | 概要 | データ型 | 長さ | NOT NULL | 列制約 | 備考 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | 〇 | | id | タスクID | タスクを一意に識別するID | SERIAL | - | 〇 | | |
| 2 | | 〇 | project_id | プロジェクトID | 紐づくプロジェクトのID | SERIAL | - | 〇 | FK (projects.id) | |
| 3 | | 〇 | assigned_user_id | 担当ユーザーID | タスクを担当するユーザーのID | SERIAL | - | | FK (users.id) | 未アサイン許容 |
...
| No | PK | UK | カラム名 | 項目名 | 概要 | データ型 | 長さ | NOT NULL | 列制約 | 備考 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | 〇 | | id | コメントID | コメントを一意に識別するID | SERIAL | - | 〇 | | |
| 2 | | | task_id | タスクID | 紐づくタスクのID | SERIAL | - | 〇 | FK (tasks.id) | |
| 3 | | | user_id | ユーザーID | コメントを投稿したユーザーのID | SERIAL | - | 〇 | FK (users.id) | |
...
| No | PK | UK | カラム名 | 項目名 | 概要 | データ型 | 長さ | NOT NULL | 列制約 | 備考 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | 〇 | | id | ラベルID | ラベルを一意に識別するID | SERIAL | - | 〇 | | |
...
| No | PK | UK | カラム名 | 項目名 | 概要 | データ型 | 長さ | NOT NULL | 列制約 | 備考 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | 〇 | | id | ID | 紐付けを一意に識別するID | SERIAL | - | 〇 | | |
| 2 | | 〇 | task_id | タスクID | 紐づくタスクのID | SERIAL | - | 〇 | FK (tasks.id) | UKはlabel_idと複合 |
| 3 | | 〇 | label_id | ラベルID | 紐づくラベルのID | SERIAL | - | 〇 | FK (labels.id) | UKはtask_idと複合 |
| 4 | | | created_at | 作成日時 | レコードの作成日時 | TIMESTAMP | - | 〇 | DEFAULT CURRENT_TIMESTAMP | |
| 5 | | | updated_at | 更新日時 | レコードの最終更新日時 | TIMESTAMP | - | 〇 | DEFAULT CURRENT_TIMESTAMP | |
